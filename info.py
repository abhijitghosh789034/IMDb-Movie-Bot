...
API_ID = int(environ['API_ID'23685328])
API_HASH = environ['API_HASH'560f107ef98507cdd0a567a665b9ad80]
BOT_TOKEN = environ['BOT_TOKEN']7681371317:AAEyxQzgCWHWtgphkXwjvARopQGWhRUt_NY
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7681371317').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1002389301055').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
ADMINS.append(7681371317)
auth_channel = environ.get('AUTH_CHANNEL'-1002389301055)
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://abhijitghosh789034:<abhijitghosh789034>@cluster0.jwroecy.mongodb.net/")
DATABASE_NAME = environ.get('DATABASE_NAME', "mongodb")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002442064939))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '2576014893')).split()]
